...
export const siteConfig: SiteConfig = {
	...
	description:
		"Notes on cloud, data, and AI systems — plus whatever else I happen to be working through. Written by Anurag Parida.",
	lang: "en-US",
	ogLocale: "en_US",
	...
	profile: {
		name: "Anurag Parida",
		email: "hi@anuragparida.com",
		github: "https://github.com/anuragparida",
		linkedin: "https://www.linkedin.com/in/anuragparida/",
		jobTitle: "Software Engineer — Cloud, Data & AI",
		employer: "HDI Group",
		employerUrl: "https://www.hdi.global/",
		alumni: "Technische Hochschule Würzburg-Schweinfurt",
	},
